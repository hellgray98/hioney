      ...
      <div className="p-4 sm:p-5 lg:p-6">
        <div className="space-y-3 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 mb-5">
          ...
          <div className={`rounded-xl sm:rounded-2xl p-4 ${
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-red-500 flex items-center justify-center flex-shrink-0 shadow-sm">
                ...
                <span className="text-sm sm:text-xs font-semibold text-gray-700 dark:text-gray-300">Dư nợ</span>
              </div>
            </div>
            <p className="text-xl sm:text-base sm:lg:text-xl font-bold text-red-600 dark:text-red-400">
          ...
          <div className={`rounded-xl sm:rounded-2xl p-4 ${
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-green-500 flex items-center justify-center flex-shrink-0 shadow-sm">
                  <svg className="w-5 h-5 sm:w-5 sm:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <span className="text-sm sm:text-xs font-semibold text-gray-700 dark:text-gray-300">Khả dụng</span>
              </div>
            </div>
            <p className="text-xl sm:text-base sm:lg:text-xl font-bold text-green-600 dark:text-green-400">
          ...
          <div className={`rounded-xl sm:rounded-2xl p-4 ${
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-xs font-semibold text-gray-700 dark:text-gray-300">Tỷ lệ sử dụng</span>
              </div>
            </div>
            <p className={`text-xl sm:text-base sm:lg:text-xl font-bold ${getUtilizationColor(overallUtilization)}`}>
        ...
        <div className="space-y-2.5 sm:space-y-2">
          {activeCards.slice(0, 3).map((card) => (
            <div 
              key={card.id}
              className={`group rounded-xl sm:rounded-2xl p-3.5 sm:p-3 transition-all duration-200 cursor-pointer active:scale-[0.98] sm:hover:scale-[1.01] ${
                theme === 'dark'
                  ? 'bg-gray-800 active:bg-gray-700 sm:hover:bg-gray-800/80'
                  : 'bg-gray-50 active:bg-gray-100 sm:hover:bg-gray-100'
              }`}
              onClick={onViewDetails}
            >
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-base sm:text-base font-bold text-gray-900 dark:text-white truncate">
                    {card.issuer}
                  </p>
                  <p className="text-sm sm:text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                    •••• {card.last4}
                  </p>
                </div>
          ...
          {activeCards.length > 3 && (
            <button
              onClick={onViewDetails}
              className={`w-full rounded-xl p-3.5 sm:p-3 text-sm font-semibold transition-all active:scale-95 ${
                theme === 'dark'
