  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 relative overflow-hidden transition-all duration-1000 ${
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className={`absolute -bottom-40 -right-40 w-96 h-96 rounded-full blur-2xl animate-float-delayed ${
          theme === 'dark' ? 'bg-gray-900/20' : 'bg-gray-100/30'
        }`}></div>
        <div className={`absolute top-1/4 left-1/3 w-64 h-64 rounded-full blur-xl animate-pulse-slow ${
          theme === 'dark' ? 'bg-gray-700/25' : 'bg-white/15'
        }`}></div>
        
        {/* Geometric Shapes */}
        <div className={`absolute top-32 right-32 w-28 h-28 rotate-12 animate-spin-slow ${
          theme === 'dark' ? 'bg-gradient-to-br from-black/10 to-gray-900/5' : 'bg-gradient-to-br from-white/10 to-gray-100/5'
        }`} style={{ borderRadius: '35%' }}></div>
        <div className={`absolute bottom-32 left-32 w-20 h-20 animate-bounce-slow ${
          theme === 'dark' ? 'bg-gradient-to-tl from-gray-800/15 to-black/10' : 'bg-gradient-to-tl from-gray-200/15 to-white/10'
        }`} style={{ borderRadius: '45%', animationDelay: '1.5s' }}></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className={`backdrop-blur-2xl rounded-2xl p-6 shadow-xl border animate-slide-up transform hover:scale-[1.01] transition-all duration-500 ${
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <svg className={`w-5 h-5 text-gray-400 transition-colors ${
                    theme === 'dark' ? 'group-focus-within:text-white' : 'group-focus-within:text-gray-900'
            ...
            {/* Email Field */}
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-900">
                Email
              </label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-12 pr-12 py-4 rounded-2xl border-2 transition-all duration-300 focus:outline-none focus:ring-0 ${
                    theme === 'dark'
                      ? 'bg-gray-50/90 border-gray-300 text-gray-900 placeholder-gray-500 focus:border-gray-900 focus:bg-white focus:shadow-lg'
                      : 'bg-gray-900/90 border-gray-600 text-white placeholder-gray-400 focus:border-white focus:bg-black focus:shadow-lg'
                  }`}
              ...
              <div className="space-y-2 animate-fade-in">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  {formData.password.length >= 8 && /[A-Z]/.test(formData.password) && /[0-9]/.test(formData.password)
                    ...
                    : formData.password.length >= 6
                    ? '⚡ Mật khẩu trung bình'
                    : '⚠️ Mật khẩu yếu (tối thiểu 6 ký tự)'
                  }
                </p>
              </div>
            )}
          ...
          <div className="my-8 flex items-center">
            ...
            <span className="px-4 text-sm text-gray-500 text-white bg-white dark:bg-gray-800 rounded-full">
              Hoặc
            </span>
            <div className="flex-1 border-t border-gray-300 dark:border-gray-600"></div>
          </div>
          ...
          <div className="text-center">
            ...
            <button
              ...
              className={`w-full py-4 px-6 rounded-2xl font-semibold border-2 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] ${
                theme === 'dark'
